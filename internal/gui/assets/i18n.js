...
const I18N = {
  zh: {
    ...
    "Import link": "导入链接",
    "Import…": "导入…",
    "Bring over providers set up in CC Switch or Alma": "把 CC Switch 或 Alma 里已配置的供应商导入进来",
    "Import from other apps": "从其他应用导入",
    "Import": "导入",
    "{n} selected": "已选 {n} 个",
    "Reading CC Switch and Alma…": "正在读取 CC Switch 和 Alma…",
    ...
    "1 model": "1 个模型",
    "Add as another key of {name}": "作为 {name} 的另一个密钥",
