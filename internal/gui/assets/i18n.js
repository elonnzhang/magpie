...
const I18N = {
  zh: {
    ...
    "In use": "使用中",
    "Requests go out with the key in use. Keep several — personal and team, paid and free — and switch any time.": "请求使用标记为「使用中」的密钥。可以保存多个——个人的、团队的、付费的、免费的——随时切换。",
    "Add another key": "添加另一个密钥",
    "Name, e.g. Team": "名称，例如 团队",
    "Name, e.g. Personal or Team": "名称，例如 个人 或 团队",
    "Rename": "重命名",
    "Key removed": "已移除密钥",
    "Key added — switch to it any time": "已添加密钥，随时可以切换",
    "{name} now uses {key}": "{name} 已切换为 {key}",
    "Use": "使用",
