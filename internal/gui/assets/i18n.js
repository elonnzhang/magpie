...
const I18N = {
  zh: {
    ...
    "To add one, sign in to it in {agent} ({how}); magpie remembers every account it sees there. Sessions already running keep their account until restarted.": "要添加账号，在 {agent} 里登录它（{how}）；magpie 会记住在那里见过的每个账号。已在运行的会话会保持原账号，重启后才切换。",
    "None yet": "暂无",
    "Forget": "忘记",
    "magpie forgets this account's sign-in; the account itself is untouched": "magpie 忘掉这个账号的登录信息；账号本身不受影响",
    "{user} forgotten": "已忘记 {user}",
    "Switch": "切换",
